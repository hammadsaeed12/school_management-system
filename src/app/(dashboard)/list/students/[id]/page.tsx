...
const SingleStudentPage = () => {
  return (
    <div className="flex-1 p-4 flex flex-col xl:flex-row">
      ...
      {/* RIGHT */}
      <div className="w-full lg:w-1/3 flex flex-col gap-4 pl-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            ...
            <Link className="p-3 rounded-md bg-lamaYellowLight" href={`/list/exams?classId=${2}`}>
              Student&apos;s Exams
            </Link>
            <Link className="p-3 rounded-md bg-lamaSkyLight" href={`/list/assignments?classId=${2}`}>
              Student&apos;s Assingments
            </Link>
            <Link className="p-3 rounded-md bg-pink-50" href={`/list/results?studentId=${"student2"}`}>
              Student&apos;s Results
            </Link>
          </div>
        </div>
